...
export class Migration20220802113526 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "image" ("id" serial primary key, "created_at" timestamp not null, "updated_at" timestamp not null, "name" varchar(255) not null, "user_email" varchar(255) not null);');
